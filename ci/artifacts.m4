...
file dist/unified/RedXpert-VERSION.tar.gz tar.gz
file dist/unified/RedXpert-VERSION.zip zip
end
...
file dist-src/RedXpert-VERSION-src.tar.gz tar.gz
file dist-src/RedXpert-VERSION-src.zip zip
end
