...
file dist/unified/RedExpert-VERSION.tar.gz tar.gz
file dist/unified/RedExpert-VERSION.zip zip
end
...
file dist-src/RedExpert-VERSION-src.tar.gz tar.gz
file dist-src/RedExpert-VERSION-src.zip zip
end
