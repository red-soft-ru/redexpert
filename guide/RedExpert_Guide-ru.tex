...
\begin{enumerate}[leftmargin=20pt]
	...
	\item Поставьте галочку на параметре \textit{Использовать файл конфигурации}, чтобы указать конфигурационный файл с настройками аудита. Вы можете настроить список отслеживаемых событий, нажав на кнопку \textit{Сгенерировать файл конфигурации}.
...
В таблице событий по умолчанию отображаются все возможные столбцы, содержащие информацию о зарегистрированном событии. По желанию некоторые столбцы можно скрыть. Для этого зайдите на вкладку \ttt{Видимые столбцы} и внесите необходимые изменения.
