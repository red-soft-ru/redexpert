...
\begin{enumerate}[leftmargin=15pt]
	...
	\item Запустите установку Red Expert с помощью файла \ttt{red\_expert\_installer-1.0.4-xxxxxx}. Инсталляция Red Expert осуществляется с помощью стандартного мастера установки программ. 
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.4\linewidth]{img/connections.png}
\end{figure}
