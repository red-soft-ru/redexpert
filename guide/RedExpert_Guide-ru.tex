...
\begin{itemize}[leftmargin=15pt]
	...
	\item Если для вашей системы не предусмотрен инсталятор, то можно запустить приложение командой "java -jar RedExpert.jar" из каталога в котором находится RedExpert.jar
\end{itemize}
\end{redremark}
\end{enumerate}	
