...
\begin{longtable}[r]{|>{\ttfamily}m{6cm}|m{9cm}|}
	...
	&  Определяет абсолютный или относительный путь к файлу \ttt{redexpert\_log.txt}. Для использования относительного пути в начале строки необходимо дописать \ttt{../}.\\\hline
