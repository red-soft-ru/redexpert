...
Если файл-исходник уже считан в таблицу предпросмотра, то при изменении полей \ttt{Разделитель} или \ttt{Первая строка заголовки столбцов источника} изменения будут применяться автоматически.
