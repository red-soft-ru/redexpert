...
\begin{figure}[H]
	\begin{center}
		\begin{minipage}[h]{0.49\linewidth}
			\includegraphics[width=1\linewidth]{img/install_1.svg}
			\caption{Приветственное окно установки} 
		\end{minipage}
		\hfill 
		\begin{minipage}[h]{0.49\linewidth}
			\includegraphics[width=1\linewidth]{img/install_2.svg}
...
\begin{figure}[H]
	\begin{center}
		\begin{minipage}[h]{0.49\linewidth}
			\includegraphics[width=1\linewidth]{img/install_3.svg}
			\caption{Выбор каталога установки} 
		\end{minipage}
		\hfill 
		\begin{minipage}[h]{0.49\linewidth}
			\includegraphics[width=1\linewidth]{img/install_4.svg}
...
\begin{tikzpicture}
\pgftext{\includegraphics[width=14pt]{img/red_expert.svg}} at (0pt,0pt)
\end{tikzpicture}
на рабочем столе.
...
\begin{figure}[H]
	\begin{flushright}
		\includegraphics[width = 0.94\linewidth]{img/status_bar.svg}
	\end{flushright}
\end{figure}
...
С его помощью выполняется подключение и отключение от базы данных, просматриваются все настройки подключения.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/browser_db.svg}
	\end{figure}
...
Предназначен для регистрации в Red Expert других JDBC драйверов помимо Jaybird Driver, а также просмотра и редактирования их настроек.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/new_drivers.svg}
	\end{figure}
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/driver_show.svg}
	\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.8\linewidth]{img/create_db.svg}
\end{figure}
...
Каждый созданный объект базы данных (процедура, индекс, таблица и т.д.) можно просматривать и изменять через графический интерфейс.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/table_explor.svg}
	\end{figure}
...
Инструмент просмотра и выполнения операторов SQL.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/query_editor.svg}
	\end{figure}
...
Текстовый редактор для временного отображения или редактирования текста по мере необходимости.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/scratch_pad.svg}
	\end{figure}
...
Для управления пользователями базы данных (создания, изменения и удаления) через графический интерфейс.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/user_manager.svg}
	\end{figure}
...
Графический интерфейс для назначения и отзыва привилегий.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/priv_manager.svg}
	\end{figure}
...
Позволяют серверу отслеживать и записывать в лог-файлы все события, происходящие с базой данных, такие как: соединение и отсоединение от БД (создание и удаление БД), операции DML и DDL, выполнение хранимых процедур и т.д.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/trace_manager.svg}
	\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/test_data_generator_1.svg}
\end{figure}
...
Отображение всей информации, которая выводится в стандартный поток вывода, ошибки и предупреждения.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/system_log.svg}
	\end{figure}
...
Графическая визуализация схемы базы данных.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/er_diagram.svg}
	\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.8\linewidth]{img/compareDB_module.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.95\linewidth]{img/ImportData.svg}
\end{figure}
...
Для поиска аналогичных типов данных двух разных СУБД, которые наиболее точно соответствуют друг другу.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/compare_types2.svg}
	\end{figure}
...
Выполнение хранимых объектов через графический интерфейс.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.7\linewidth]{img/execute_store_proc.svg}
	\end{figure}
...
Для сохранения результата выборки \ttt{SELECT} запроса в текстовом файле.
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/export_result.svg}
	\end{figure}
...
Можно заранее написать код из SQL команд во внешнем редакторе и сохранить его в файле операционной системы. Red Expert позволяет работать с такими файлами: считывать их в буфер, запускать на выполнение и сохранять набранные команды в файле.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.8\linewidth]{img/execute_script.svg}
	\end{figure}

Список всех открытых в настоящее время вкладок можно посмотреть, нажав на кнопку \begin{tikzpicture}
\pgftext{\includegraphics[width=14pt]{img/button_alltabs.svg}} at (0pt,0pt)
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.95\linewidth]{img/output_console.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.6\linewidth]{img/connections.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.8\linewidth]{img/procedure_view.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.4\linewidth]{img/keywords.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.35\linewidth]{img/drivers.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/status_bar.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/toolbar.svg}
\end{figure}
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/new16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Открыть редактор запросов & Shift+F12\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=14pt]{img/open16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Открыть файл & Ctrl+L\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/save16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сохранить файл & Ctrl+S\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/print16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Печать & Ctrl+P\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/PrintPreview16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Предварительный просмотр перед печатью & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/SaveAs16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сохранить как & Ctrl+Shift+S\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/PageSetup16.svg}} at (0pt,0pt)
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/cut16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Вырезать & Ctrl+X\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Copy16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Копировать & Ctrl+C\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Paste16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Вставить & Ctrl+V\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Undo16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Отмена действий & Ctrl+Z\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Redo16.svg}} at (0pt,0pt)
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/DBImage24.svg}} at (0pt,0pt)
	\end{tikzpicture} & Создать подключение & Ctrl+Shift+N\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Edit16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Открыть редактор запросов & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/create_database16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Создать базу данных & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/CreateScripts16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сгенерировать SQL скрипт & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=10pt]{img/Procedure16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Выполнить хранимые объекты & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=10pt]{img/user_manager_16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Менеджер пользователей & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/grant_manager_16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Менеджер прав & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/CompareDataTypes16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сравнить типы данных & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Keywords16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Пользовательские ключевые слова & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/SystemConsole16.svg}} at (0pt,0pt)
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Find16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Найти & Ctrl+F\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/FindAgain16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Найти далее & F3\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Replace16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Заменить & Ctrl+R\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/GoTo16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Перейти к ... & Ctrl+G\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/FindInFiles16.svg}} at (0pt,0pt)
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Preferences16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Настройки & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Help16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Разделы справки & F1\\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/About16.svg}} at (0pt,0pt)
	\end{tikzpicture} & О программе & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/WebComponent16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Посетить red-soft.ru & \\
	\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ResourceHeap16.svg}} at (0pt,0pt)
...
\begin{enumerate}[leftmargin=15pt]
	...
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=14pt]{img/NewJDBCDriver16.svg}} at (0pt,0pt)
	\end{tikzpicture}
...
\begin{enumerate}[leftmargin=15pt]
	...
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=14pt]{img/create_database16.svg}} at (0pt,0pt)
	\end{tikzpicture}
...
\begin{enumerate}[leftmargin=15pt]
	...
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=14pt]{img/NewConnection16.svg}} at (0pt,0pt)
	\end{tikzpicture}
...
\begin{enumerate}[leftmargin=15pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.55\linewidth]{img/IBExpert_env_opt.svg}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.35\linewidth]{img/import_connections.svg}
	\end{figure}
...
\begin{longtable}[c]{|m{5mm}|m{10.6cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Execute16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Выполнить все операторы в редакторе & Ctrl+Shift+Enter\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/PartialExecute16.svg}} at (0pt,0pt)
	...
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ExecuteSelection16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Выполнить любой выделенный текст в редакторе & F9\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/plan.svg}} at (0pt,0pt)
	\end{tikzpicture} & Печать плана запроса & Ctrl+Shift+P\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Stop16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Отмена выполнения текущего оператора & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ClearOutput16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Очистить окно вывода (окно Output) & Ctrl+Shift+Backspace\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/History16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Показать диалоговое окно истории выполненных запросов & Ctrl+Shift+H\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Bookmarks16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Закладки для хранения запросов. Для удобного поиска важных запросов  & Ctrl+B\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Shortcut16.svg}} at (0pt,0pt)
	...
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/RecycleConnection16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Закрытие соединения, выделенного для редактора запросов, и его повторное открытие & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/TableRefresh16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Обновить список ключевых слов & Alt+Shift+R\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/RSMetaData16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Отображает метаданные выбранного множества результатов (Result Set) & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/TableColumn16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Показывает диалоговое окно, в котором можно выбрать какие столбцы выборки скрыть & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ExportDelimited16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Экспорт выборки в файл & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ToggleEditorOutput16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Показать/скрыть окно вывода & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ShiftTextLeft16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сдвиг текущей строки влево & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ShiftTextRight16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сдвиг текущей строки вправо & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/AddComment16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Закомментировать текущую строку или выделение & Ctrl+/\\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/FormatSql16.svg}} at (0pt,0pt)
...
\begin{tikzpicture}
\pgftext{\includegraphics[width=12pt]{img/GoToResultSetQuery16.svg}} at (0pt,0pt)
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.4\linewidth]{img/input_param.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.4\linewidth]{img/input_param2.svg}
\end{figure}
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_index.svg}
	\end{figure}	
...
\begin{figure}[H]
	...
	\centering
	\includegraphics[width = 0.48\linewidth]{img/create_index2.svg}
\end{figure}
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/selectivity.svg}
	\end{figure}	
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/selectivity2.svg}
	\end{figure}	
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.7\linewidth]{img/create_proc.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.65\linewidth]{img/create_seq.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.65\linewidth]{img/create_table.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных
	...
	\pgftext{\includegraphics[width=11pt]{img/ColumnInsertBefore16.svg}} at (0pt,0pt)
	\end{tikzpicture} или
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ColumnInsertAfter16.svg}} at (0pt,0pt)
	\end{tikzpicture}. 
	Чтобы удалить поле, нажмите на кнопку 
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ColumnDelete16.svg}} at (0pt,0pt)
	\end{tikzpicture}. Также есть возможность изменять последовательность полей с помощью стрелок \begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/Up16.svg}} at (0pt,0pt)
	\end{tikzpicture}, \begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/Down16.svg}} at (0pt,0pt)
	\end{tikzpicture}.
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/alter_table.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.8\linewidth]{img/dependence.svg}
\end{figure}
...
\pgftext{\includegraphics[width=11pt]{img/add_16.svg}} at (0pt,0pt)
\end{tikzpicture} и добавится новая строка таблицы. Выделите строку таблицы и нажмите кнопку \begin{tikzpicture}
\pgftext{\includegraphics[width=11pt]{img/delete_16.svg}} at (0pt,0pt)
...
\pgftext{\includegraphics[width=11pt]{img/Commit16.svg}} at (0pt,0pt)
\end{tikzpicture} или же откатить их (\begin{tikzpicture}
\pgftext{\includegraphics[width=11pt]{img/Rollback16.svg}} at (0pt,0pt)
\end{tikzpicture}).
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_trigger.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_dbtrigger.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных
	\item Введите уникальное имя триггера
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_ddltrigger.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных
	\item Введите уникальное имя триггера
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.7\linewidth]{img/create_view.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_domain.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_exception.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_exfunc.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_func.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_gtt.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.75\linewidth]{img/create_package.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.35\linewidth]{img/create_role.svg}
	\end{figure}
...
\pgftext{\includegraphics[width=12pt]{img/no_grant.svg}} at (0pt,0pt)
\end{tikzpicture} означает, что у роли нет таких прав на объект. Точка \begin{tikzpicture}
\pgftext{\includegraphics[width=12pt]{img/admin_option.svg}} at (0pt,0pt)
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.6\linewidth]{img/create_user.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.6\linewidth]{img/create_tablespace.svg}
	\end{figure}
	\item Введите запрашиваемые данные в данном окне.
	\item Нажмите кнопку \textit{OK}. Появится новое диалоговое окно для подтверждения или отката операции создания роли (см. \hyperref[ris:01]{рис.~\ref{ris:01}}).
	\item Проверьте сгенерированный SQL код.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.6\linewidth]{img/create_job.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.6\linewidth]{img/create_job_cron.svg}
	\end{figure}
\end{enumerate}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.6\linewidth]{img/create_job_log.svg}
\end{figure}
...
\begin{enumerate}[leftmargin=20pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.7\linewidth]{img/recompile2.svg}
	\end{figure}
	\item Нажмите кнопку \textit{ОК}. 
\end{enumerate}
\newpage
...
\begin{enumerate}[leftmargin=20pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.9\linewidth]{img/execute_store_proc.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\pgftext{\includegraphics[width=10pt]{img/CompareDataTypes16.svg}} at (0pt,0pt)
	\end{tikzpicture} на главной панели инструментов. Откроется вкладка на центральной панели.
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.9\linewidth]{img/compare_types.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.9\linewidth]{img/export_set.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.92\linewidth]{img/execute_input.svg}
	\end{figure}
	\item Выберите открытое соединение.
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/compareDB_module.svg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/compareDB_module_example.svg}
	\caption{Найденные различия}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/compareDB_module_exampleSQL.svg}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/test_data_generator_2.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.18\linewidth]{img/erd1.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.45\linewidth]{img/erd2.svg}
\end{figure}
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/NewTable16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Создать новую таблицу & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/AddTable16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Добавить таблицу из существующей базы данных & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/TableRelationship16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Создать табличную связь посредством внешних ключей & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/TableRelationshipDelete16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Удалить связь между выбранными таблицами & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/DropTable16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Удалить выбранные таблицы с диаграммы & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/CreateScripts16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Сгенерировать SQL скрипт создания таблиц & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ErdTitle16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Добавить описательный заголовок диаграммы & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/FontStyle16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Изменить шрифт всех таблиц & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/LineStyle16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Изменить стиль линий связи & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ErdForeground16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Изменить цвет фона содержимого выбранных таблиц & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ErdBackground16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Изменить цвет холста & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ZoomOut16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Уменьшить размер & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/ZoomIn16.svg}} at (0pt,0pt)
...
\begin{enumerate}
	...
	\pgftext{\includegraphics[width=11pt]{img/Forward16.svg}} at (0pt,0pt)
	\end{tikzpicture},
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=11pt]{img/SelectAll16.svg}} at (0pt,0pt)
	\end{tikzpicture}
...
\begin{longtable}[c]{|m{5mm}|m{9cm}|>{\ttfamily}m{4cm}|}
	...
	\endhead
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/NewScratchPad16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Открыть новый черновик & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/ScratchToEditor16.svg}} at (0pt,0pt)
	\end{tikzpicture} & Открыть редактор запросов с содержимым черновика & \\\hline
	\begin{tikzpicture}
	\pgftext{\includegraphics[width=12pt]{img/Delete16.svg}} at (0pt,0pt)
...
\begin{enumerate}[leftmargin=39pt]
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width = 0.7\linewidth]{img/user_keywords.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\pgftext{\includegraphics[width=12pt]{img/user_manager_16.svg}} at (0pt,0pt)
	\end{tikzpicture} на главной панели инструментов. На центральной панели откроется новая вкладка:
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.92\linewidth]{img/user_manager.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.92\linewidth]{img/grant_role.svg}
	\end{figure}
...
\begin{enumerate}[leftmargin=39pt]
	...
	\begin{figure}[H]
		\flushright
		\includegraphics[width = 0.92\linewidth]{img/priv_manager.svg}
	\end{figure}
	\item Выберите открытое соединение с базой данных.
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 1\linewidth]{img/trace_mag3.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.95\linewidth]{img/trace_mag2.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.85\linewidth]{img/session_manager.svg}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width = 0.45\linewidth]{img/select_shortcut.svg}
\end{figure}
