...
Диалоговое окно \textit{Пересчет селективности} позволяет создавать новые индексы таблиц базы данных в выбранном соединении с базой данных.
...
\begin{enumerate}[leftmargin=26pt]
	...
	\end{figure}	
	\item Нажмите кнопку \textit{Да}. Появится новое диалоговое окно со списком SQL-запросов выполняющих пересчет статистики у всех индексов  
	\begin{figure}[H]
		\centering
...
\begin{enumerate}[leftmargin=20pt]
	...
	\item Нажмите правой кнопкой мыши на узел с процедурами(триггерами, функциями и пакетами) \begin{tikzpicture}
		\pgftext{\includegraphics[width=100pt]{img/recompile.png}} at (0pt,0pt)
	\end{tikzpicture} И выберите в контекстном меню пункт  \textit{Перекомпилировать все Процедуры}.
	\item Подтвердите действие в открывшемся диалоговом окне и откроется диалоговое окно со списком sql запросов пересоздания каждой процедуры
	\begin{figure}[H]
		\centering
