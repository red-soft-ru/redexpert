...
\anonsubsubsection{\hyperref[sec:connections]{Браузер баз данных}}
...
С его помощью выполняется подключение и отключение от базы данных, просматриваются все настройки подключения.
	...
	\end{figure}
\anonsubsubsection{\hyperref[sec:new_driver]{Компонент для установки JDBC драйверов}}
...
\anonsubsubsection{\hyperref[sec:create_db]{Компонент для создания новой базы данных}}
...
\anonsubsubsection{\hyperref[sec:objects]{Обозреватели и редакторы объектов базы данных}}
...
\anonsubsubsection{\hyperref[sec:query_editor]{Редактор запросов}}
...
\anonsubsubsection{\hyperref[sec:draft]{Черновик}}
...
\anonsubsubsection{\hyperref[sec:user_manager]{Менеджер пользователей}} 
...
\anonsubsubsection{\hyperref[sec:priv_manager]{Менеджер прав}} 
...
\anonsubsubsection{\hyperref[sec:trace_manager]{Трейс менеджер}}  
...
\anonsubsubsection{\hyperref[sec:test_data_generator]{Генератор тестовых данных}}
...
\anonsubsubsection{\hyperref[sec:logout]{Обозреватель системного журнала состояний вывода}}
...
\anonsubsubsection{\hyperref[sec:erd]{Построитель ER-диаграмм}} 
...
\anonsubsubsection{\hyperref[sec:compare_datatype]{Компонент для сравнения типов данных}}
...
\anonsubsubsection{\hyperref[sec:execute_proc]{Компонент для выполнения хранимых процедур и функций}}
...
\anonsubsubsection{\hyperref[sec:export_results]{Компонент для экспорта результатов SELECT запроса}} 
...
\anonsubsubsection{\hyperref[sec:execute_scripts]{Компонент для выполнения скриптов из файла}}
...
\begin{itemize}[leftmargin=10pt]
	...
	Список должен состоять из элементов соответствующего типа данных, разделенных специальным символом (разделителем). Сам список можно ввести вручную в предназначенном для этого поле, либо загрузить из файла. 
