...
public class FBCreateDatabaseImpl implements IFBCreateDatabase {
    ...
    public void exec() throws SQLException {
        ...
        final FbConnectionProperties connectionInfo;
        {
            ...
            connectionInfo.setIntProperty("page_size", pageSize);
            connectionInfo.setProperty("set_db_charset", encoding);
            if (jdbcProperties != null) {
                for (String key : jdbcProperties.stringPropertyNames()) {
                    connectionInfo.setProperty(key, jdbcProperties.getProperty(key));
                }
            }
