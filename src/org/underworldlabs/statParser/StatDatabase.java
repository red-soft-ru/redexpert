...
public class StatDatabase extends TableModelObject {
    ...
    public static final String[][] ITEMS_HDR = {
            {"Flags", "i", null, null},
            {"Checksum", "i", null, null},
            {"Generation", "i", null, null},
            {"System Change Number", "i", "system_change_number", null},
            {"Page size", "i", null, null},
            {"Server", "s", null, null},
            {"ODS version", "s", "ods_version", null},
            {"Oldest transaction", "i", "oit", null},
            {"Oldest active", "i", "oat", null},
            {"Oldest snapshot", "i", "ost", null},
            {"Next transaction", "i", null, null},
            {"Bumped transaction", "i", null, null},
            {"Autosweep gap", "i", null, null},
            {"Sequence number", "i", null, null},
            {"Next attachment ID", "i", "next_attachment_id", null},
            {"Implementation ID", "i", "implementation_id", null},
            {"Implementation", "s", null, null},
            {"Shadow count", "i", null, null},
            {"Page buffers", "i", null, null},
            {"Next header page", "i", null, null},
            {"Database dialect", "i", null, null},
            {"Creation date", "d", null, null},
            {"Attributes", "l", null, null},
    };
