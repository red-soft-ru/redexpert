...
public class ShortcutTextField extends JTextField {
    ...
    protected void processKeyEvent(KeyEvent evt) {
        ...
        if (!MiscUtils.isNull(modifiers))
            sb.append(modifiers);

        keyStrokeText.append(isKeyKodeValid(keyCode) && MiscUtils.isNull(modifiers) ? modifiers : getKeyText(keyCode));
        setText(sb.toString());
    }

    private boolean isKeyKodeValid(int keyCode) {
    ...
    public String getKeyStrokeText() {
        return keyStrokeText != null ? keyStrokeText.toString() : "";
    }
