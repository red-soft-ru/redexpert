...
//                "TableHeader.background", new ColorUIResource(60,63,65),
                "TableHeader.background", new ColorUIResource(60,61,62),
...
//                "executequery.ScrollingTabPane.closeButtonFocus", new ColorUIResource(0x212020),
                ...
                "TableHeader.cellBorder", new org.underworldlabs.swing.plaf.ThinTableHeaderLineBorderUIResource(),
                ...
                "results.table.cell.blob.background.colour", new ColorUIResource(-14803167),
                "sqlsyntax.colour.operator", new ColorUIResource(-5654586),
                "editor.text.background.alternate.color", new ColorUIResource(-1314561),
                "results.table.focus.row.background.colour", new ColorUIResource(-14597501),
                "sqlsyntax.colour.quote", new ColorUIResource(-9795751),
                "desktop.background.custom.colour", new ColorUIResource(-6710836),
                "editor.text.selection.background.alternative", new ColorUIResource(-13408615),
                "sqlsyntax.colour.datatype", new ColorUIResource(-3377102),
                ...
                "results.table.cell.null.deleting.background.colour", new ColorUIResource(-14803167),
                "results.table.cell.deleted.background.colour", new ColorUIResource(-12253947),
                "results.table.cell.numeric.background.colour", new ColorUIResource(-14803167),
                "results.table.cell.null.background.colour", new ColorUIResource(-14803167),
                "results.table.cell.changed.background.colour", new ColorUIResource(-13085328),
                "editor.caret.colour", new ColorUIResource(-4473925),
                ...
                "results.table.cell.boolean.background.colour", new ColorUIResource(-14803167),
                "results.table.cell.date.background.colour", new ColorUIResource(-14803167),
                "sqlsyntax.colour.singlecomment", new ColorUIResource(-8355712),
                "editor.linenumber.background", new ColorUIResource(-14803166),
                "editor.text.foreground.colour", new ColorUIResource(-5654586),
                "results.table.cell.null.adding.background.colour", new ColorUIResource(-14803167),
                "sqlsyntax.colour.number", new ColorUIResource(-9922629),
                "results.table.cell.new.background.colour", new ColorUIResource(-13085328),
                "sqlsyntax.colour.literal", new ColorUIResource(-3377102)
